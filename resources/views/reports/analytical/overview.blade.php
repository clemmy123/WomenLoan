    ...
    <div class="app-page-header">
        <div>
            <div class="app-page-heading-row">
                <h1 class="app-page-title lg:text-3xl">{{ __('analytical_reports.overview_title') }}</h1>
            ...
            <p class="app-page-subtitle">{{ __('analytical_reports.overview_subtitle') }}</p>
        </div>
...
@include('partials.chart-js', ['module' => 'js/pages/analytical-reports.js'])
@endpush
@endif
