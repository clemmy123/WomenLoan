...
<div class="page">
    <div class="page-header">
        <div>
            <h1 class="page-title lg:text-3xl">{{ __('general_reports.title') }}</h1>
            <p class="page-subtitle">{{ __('general_reports.subtitle') }}</p>
        </div>
    ...
    @else
        ...
        @vite(['resources/js/pages/general-reports.js'])
    @endif
</div>
@endsection
