    ...
    <div class="app-page-header">
        <div>
            <div class="app-page-heading-row">
                <h1 class="app-page-title lg:text-3xl">{{ __('by_type_reports.title') }}</h1>
                @include('partials.period-segmented', [
                    'periods' => \App\Services\ByTypeReportService::PERIODS,
                    'compact' => true,
                    'submitOnChange' => true,
                ])
            </div>
            <p class="app-page-subtitle">{{ __('by_type_reports.subtitle') }}</p>
        </div>
                ...
                <div class="wizard-field">
                    ...
                    <div class="app-filter-control">
                        <select
                            ...
                            data-primary-filter
                        >
                            <option value="">{{ __('by_type_reports.all_types') }}</option>
