...
<div class="space-y-8">
    ...
    <div class="flex flex-wrap items-end justify-between gap-4">
        ...
        @can('view reports')
            <a href="{{ route('reports.index') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold  transition">
