<nav class="space-y-1">
    ...
    <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('dashboard') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
    ...
    @if($nav['isApplicant'])
        ...
        @if($user->applicant)
            <a href="{{ route('applicants.show', $user->applicant) }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('applicants.show') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
        ...
        @elseif($nav['registerApplicant'])
            <a href="{{ route('applicants.create') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('applicants.create') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
        ...
        <a href="{{ route('loan-applications.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('loan-applications.index') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
        ...
        @if($nav['createLoan'])
            <a href="{{ route('loan-applications.create') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('loan-applications.create') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
    ...
    @if($nav['manageApplicants'])
        ...
        <a href="{{ route('applicants.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('applicants.*') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
    ...
    @if($nav['viewStaffLoans'])
        ...
        <a href="{{ route('loan-applications.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('loan-applications.*') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
    ...
    @if($nav['manageGroups'])
        ...
        <a href="{{ route('loan-groups.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('loan-groups.*') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
    ...
    @if($nav['viewRepayments'])
        ...
        <a href="{{ route('repayments.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('repayments.*') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
    ...
    @if($nav['viewReports'])
        ...
        <a href="{{ route('reports.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('reports.*') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
    ...
    @if($nav['manageUsers'] || $nav['manageRoles'])
        ...
        @if($nav['manageUsers'])
            <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.users.*') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
        ...
        @endif
        @if($nav['manageRoles'])
            <a href="{{ route('admin.roles.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.roles.*') ? 'sidebar-active' : 'text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-white/5' }}">
