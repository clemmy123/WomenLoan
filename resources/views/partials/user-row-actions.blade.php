...
<div class="app-kebab" data-kebab>
    <button
        type="button"
    ...
    <div class="app-kebab-menu app-kebab-menu--portal" data-kebab-menu hidden role="menu">
        <a href="{{ route('admin.users.show', $user) }}" class="app-kebab-item" role="menuitem">
        ...
        <a href="{{ route('admin.users.edit', $user) }}" class="app-kebab-item" role="menuitem">
        ...
        <a href="{{ route('admin.users.assign-roles', $user) }}" class="app-kebab-item" role="menuitem">
        ...
        @if (auth()->user()?->can('reset user password') && $user->id !== auth()->id())
            <a href="{{ route('admin.users.reset-password', $user) }}" class="app-kebab-item" role="menuitem">
                <span class="app-kebab-item-icon app-kebab-item-icon--edit" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/>
                    </svg>
                </span>
                <span>{{ __('admin.reset_password_emergency') }}</span>
            </a>
        @endif
        ...
        @if ($canDeactivate)
            <button
                ...
                role="menuitem"
                data-open-modal="app-modal-deactivate"
        ...
        @if ($canActivate)
            <form method="POST" action="{{ route('admin.users.activate', $user) }}">
                @csrf
                <button type="submit" class="app-kebab-item" role="menuitem">
                    <span class="app-kebab-item-icon app-kebab-item-icon--roles" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
